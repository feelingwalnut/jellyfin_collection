...
# Base directory where all movies are stored
BASE_MOVIE_DIR = '/srv/LibraryPart/Library/Movies'
nfo_directory = '/media/NAS/Library/Movies'  # Where all the movie NFOs are located
output_directory = '/home/nix/Downloads/Collections'  # Where the collection.xml files will be saved
...
if __name__ == '__main__':
    ...
    process_movie_nfo_files(nfo_directory, output_directory)
